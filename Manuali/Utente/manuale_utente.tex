...
\begin{document}
	...
	\begin{enumerate}
		...
		\item \textbf{Primo avvio (Inizializzazione Database):} Fare doppio clic sul file \filename{InitDB.bat}. Questo passaggio va eseguito \textbf{una sola volta} per creare il database.
